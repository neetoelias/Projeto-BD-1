...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card text-white bg-primary mb-3">
                <div class="card-body">
                    ...
                    <a href="nova-questao.jsp" class="btn btn-light">Acessar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-success mb-3">
                <div class="card-body">
                    ...
                    <a href="nova-avaliacao.jsp" class="btn btn-light">Acessar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-dark mb-3">
                <div class="card-body">
                    <h5 class="card-title">Criar Disciplina</h5>
                    <p class="card-text">Cadastre novas matérias no sistema.</p>
                    <a href="nova-disciplina.jsp" class="btn btn-light">Acessar</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped mt-3">
        ...
        <tr>
            ...
            <td>
                <a href="corrigir-prova.jsp?idRealizacao=<%= item.getIdRealizacao() %>"
                   class="btn btn-sm btn-warning">Corrigir</a>

                <a href="relatorio-prova.jsp?idAvaliacao=<%= item.getIdAvaliacao() %>"
                   class="btn btn-sm btn-info">Estatísticas</a>
            </td>
        </tr>
        <% } %>
